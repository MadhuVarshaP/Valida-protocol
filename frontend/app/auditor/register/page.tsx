            ...
            <div className="flex flex-col gap-8 max-w-2xl">
                <div>
                    ...
                    <p className="text-[#1A1A1A]/70 font-medium mt-2">
                        Register your wallet as a security auditor to submit vulnerability reports on the Zeno platform.
                    </p>
                </div>
                    ...
                    {status === "no-contract" && (
                        <div className="flex flex-col items-center py-10 gap-3 text-center">
                            ...
                            <p className="text-sm text-[#1A1A1A]/60 max-w-sm">
                                ...
                                not set. Ask the admin to deploy ZenoVulnerability and configure the env variable.
                            </p>
                        </div>
                    )}
                            ...
                            <div className="space-y-3">
                                ...
                                <ol className="space-y-2.5 text-sm text-[#1A1A1A]/70">
                                    {[
                                        ...
                                        "Admin calls registerAuditor() on ZenoVulnerability contract",
