/**
 * IPFS & Encryption service for Zyra Phase 3 — vulnerability detail reveals.
 *
...
async function deriveKey(): Promise<CryptoKey> {
	const rawKey = process.env.NEXT_PUBLIC_REVEAL_ENCRYPTION_KEY ?? "zyra-default-key-change-in-production";
	...
	return crypto.subtle.deriveKey(
		{
			name: "PBKDF2",
			salt: new TextEncoder().encode("zyra-vuln-salt-v1"),
