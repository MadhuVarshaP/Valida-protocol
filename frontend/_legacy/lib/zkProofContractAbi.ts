export const zkVerifierContractAbi = [
	{ "inputs": [{ "internalType": "address", "name": "_zyraVulnerability", "type": "address" }], "stateMutability": "nonpayable", "type": "constructor" },
	{
		"anonymous": false,
		"inputs": [
		...
		"outputs": [
			{
				...
				"internalType": "struct ZyraZKVerifier.ZKProofSubmission",
				"name": "",
				"type": "tuple"
			}
		],
