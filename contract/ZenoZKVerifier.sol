...
interface IZenoVulnerabilityZK {
 ...
 *         ZenoVulnerability.submissions[submissionId].commitment — enforced by require().
 */
contract ZenoZKVerifier {
    ...
    address public zenoVulnerability;
    ...
    constructor(address _zenoVulnerability) {
        admin = msg.sender;
        zenoVulnerability = _zenoVulnerability;
    }
     ...
     *
     * @param submissionId  The ZenoVulnerability submission to verify
    ...
    function submitZKProof(
        ...
        bytes32 onChainCommitment = IZenoVulnerabilityZK(zenoVulnerability)
        ...
        // 4. Auto-advance submission to Verified on ZenoVulnerability
        IZenoVulnerabilityZK(zenoVulnerability).markZKVerified(submissionId);
