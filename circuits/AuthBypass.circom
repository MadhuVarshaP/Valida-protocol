 ...
 *   systemCodeHash     — fingerprint of the target system (from ZenoVulnerability struct)
 ...
 *   via the TemplateRegistry in ZenoZKVerifier.sol without changing this circuit.
 *
 * INSTALL DEPS:
